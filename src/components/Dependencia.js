...
const Dependencia = () => {
  ...
  const getDependencias = async () => {
   //const api = await fetch("http://localhost/api_inventario/dependencia.php");
  ...
  // console.log(data)
    ...
    .then( res => res.json() )
       .then(
          ...
          /*  fetch('http://localhost/api_inventario/dependencia.php')
...
//  6- USAMOS USEEFFECT
  ...
  const registrar  =  (e) => {
    e.preventDefault();
    const rutaServicio = ApiWebUrl+"registrardependencia.php";//http://localhost/api_inventario/registrardependencia.php";
    var formData = new FormData();
    formData.append("nombre_dependencia", nombredependencia) //
  ...
  {/*
    var respuesta = window.confirm("¿Está seguro que desea eliminar al alumno(a) " + Id + " ?");
    if (respuesta === true) {
        const rutaServicio = "http://localhost/api_inventario/eliminardependencia.php";
        var formData = new FormData();
        ...
        fetch(rutaServicio, {
            ...
            .then(
                () => {
                    ...
                    alert("Se eliminó al alumno(a) " + Id);
                    getDependencias(); // importante
                }
            )
    }*/
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const rutaServicio = ApiWebUrl + "eliminardependencia.php"; //"http://localhost/api_inventario/eliminardependencia.php";
        var formData = new FormData();
        formData.append("iddependencia", Id)
        fetch(rutaServicio, {
          method: 'POST',
  ...
  const actualizar = (e)=>{
    e.preventDefault();
    const rutaServicio = ApiWebUrl+ "actualizardependencia.php"; //"http://localhost/api_inventario/actualizardependencia.php";
    var formData = new FormData();
